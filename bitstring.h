/*
    bitstring.h -- prototypes of functions defined in bitstring.c.
...
void CopyPartialBitstring(unsigned char *src, unsigned char *dest,
int bitoffset, int number_of_bits);
